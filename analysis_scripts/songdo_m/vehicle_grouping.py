...
def build_movement_to_ids_for_workset(
    ...
    from .m_rules import infer_m_movement as infer_q_movement
...
def group_vehicles_by_sections(
    ...
    from .m_rules import infer_m_movement as infer_q_movement, infer_m_movement_from_lane_sequence as infer_q_movement_from_lane_sequence, M_MOVEMENT_RULES as Q_MOVEMENT_RULES
